These notes are for the EDITORS of pmo
...
Make sure you have an ID range in the [idranges file](pmo-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [pmo-edit.owl](pmo-edit.owl)

** DO NOT EDIT pmo.obo OR pmo.owl in the top level directory **

[../../pmo.owl](../../pmo.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/hurwitzlab/planet-microbe-ontology) for details.
 ...
 * [pmo-idranges.owl](pmo-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/pmo_terms.txt file
...
Note: the pmo_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as pmo.owl and pmo.obo and places
 ...
 * https://github.com/hurwitzlab/planet-microbe-ontology/releases
 * https://github.com/hurwitzlab/planet-microbe-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived pmo.owl (`data-version` in
pmo.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/pmo.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/pmo/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/hurwitzlab/planet-microbe-ontology.svg?branch=master)](https://travis-ci.org/hurwitzlab/planet-microbe-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/hurwitzlab](https://travis-ci.org/profile/hurwitzlab)
 2. click the "Sync account" button
 3. Click the tick symbol next to planet-microbe-ontology
